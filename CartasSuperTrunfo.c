...
int main (){
    ...
    int pontosTuristicos1, pontosTuristicos2, escolhaComparacao1, escolhaComparacao2; //variavel dos pontos turistico das cartas 1 e 2
    ...
    default:
        ...
        printf("\n\nRESUMO DAS VITORIAS:\n");
    printf("Carta 1 (%s) venceu %d vezes.\n", cidade1, vitorias1);
    printf("Carta 2 (%s) venceu %d vezes.\n", cidade2, vitorias2);
    ...
    if(vitorias1 > vitorias2) {
        ...
        printf("Carta 1 e Carta 2 deu empate!\n");
    }
